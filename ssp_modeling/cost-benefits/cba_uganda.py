...
SSP_RUN  = os.path.join(SSP_PATH, "ssp_modeling/ssp_run_output/sisepuede_run_2026-03-10t13;27;53.264959/nwr")
...
CB_OUTPUT = os.path.join(SSP_PATH,"ssp_modeling/cost-benefits/cb_results")
...
# Save the results
results_all_pp_shifted.to_csv(os.path.join(CB_OUTPUT, "cba_results_test.csv"), index = False)